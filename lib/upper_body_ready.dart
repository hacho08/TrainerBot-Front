...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: UpperBodyReadyPage(), // 시작 화면
    );
  }
}

class UpperBodyReadyPage extends StatefulWidget {
  _UpperBodyReadyPageState createState() => _UpperBodyReadyPageState();
}
...
class _UpperBodyReadyPageState extends State<UpperBodyReadyPage> {
  ...
  void initState() {
    ...
    // 비디오 파일 로드
    _controller = VideoPlayerController.asset('video/upper_body_start_stretching.mp4') // 경로 수정
      ..initialize().then((_) {
