import 'dart:async';
import 'test_rest_time.dart';
import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';
import 'package:flutter_tts/flutter_tts.dart';

class TestRealExercisePage extends StatefulWidget {
  final int sets;

  final List<Map<String, dynamic>> exercises;
  final int currentIndex; // 현재 운동 인덱스

  const TestRealExercisePage(
      {Key? key,
  ...
  @override
  _TestRealExercisePageState createState() => _TestRealExercisePageState();
}

class _TestRealExercisePageState extends State<TestRealExercisePage> {
