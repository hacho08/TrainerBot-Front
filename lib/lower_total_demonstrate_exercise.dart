import 'test_before_countdown_lower.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LowerTotalDemonstrateExercisePage(currentIndex: 0), // 운동 페이지로 시작
    );
  }
}

class LowerTotalDemonstrateExercisePage extends StatefulWidget {
  final int currentIndex;

  // 생성자에서 currentIndex 받기
  LowerTotalDemonstrateExercisePage({required this.currentIndex});

  @override
  _LowerTotalDemonstrateExercisePageState createState() =>
      _LowerTotalDemonstrateExercisePageState();
}

class _LowerTotalDemonstrateExercisePageState
    extends State<LowerTotalDemonstrateExercisePage> {
  ...
  List<Map<String, dynamic>> exercises = [
    {
      ...
      'type': '하체운동',
      'name': '사이드 런지',
      'videoPath': 'video/side_lunge.mp4',
      'tts': '첫 번째 운동을 시작합니다',
    },
    {
      //index 1
                        ...
                        IconButton(
                            ...
                            onPressed: () {
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TestBeforeCountdownLowerPage(
                                      exercises: exercises,
