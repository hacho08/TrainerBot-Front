import 'dart:async';
import 'today_exercise_finish.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: UpperAndLowerBodyFinalPage(), // 시작 화면
    );
  }
}

class UpperAndLowerBodyFinalPage extends StatefulWidget {
  _UpperAndLowerBodyFinalPageState createState() => _UpperAndLowerBodyFinalPageState();
}
...
class _UpperAndLowerBodyFinalPageState extends State<UpperAndLowerBodyFinalPage> {
  ...
  void initState() {
    ...
    // 비디오 파일 로드
    _controller = VideoPlayerController.asset('video/final_stretching.mp4') // 경로 수정
      ..initialize().then((_) {
  ...
  Future<void> _initializeTts() async {
    ...
    await _flutterTts.speak("마무리 운동을 시작합니다");
  }
