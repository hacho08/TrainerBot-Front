...
class TestCountdownLowerPage extends StatefulWidget {
  final List<Map<String, dynamic>> exercises;
  final int currentIndex; // 현재 운동 인덱스를 받아옴

// 생성자를 통해 exercises 리스트를 받음
  TestCountdownLowerPage({required this.exercises, required this.currentIndex});

  @override
  _TestCountdownLowerPageState createState() => _TestCountdownLowerPageState();
}

class _TestCountdownLowerPageState extends State<TestCountdownLowerPage> {
...
// 카운트다운이 끝나면 운동 페이지로 돌아가기
  void _goToExercisePage() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => TestRealExerciseLowerPage(
            sets: 2,
