...
import 'test_real_exercise_lower.dart';
import 'upper_and_lower_body_final.dart';
import 'package:flutter/material.dart';
import 'package:flutter_tts/flutter_tts.dart';
import 'package:flutter_tts/flutter_tts.dart'; // TTS 패키지

class TestRestTimeLowerPage extends StatefulWidget {
  final int currentSet;
  final List<Map<String, dynamic>> exercises;
  final int currentIndex;

  // 생성자에서 selectedCondition을 받습니다.
  TestRestTimeLowerPage({required this.currentSet, required this.exercises, required this.currentIndex});

  @override
  _TestRestTimeLowerPageState createState() => _TestRestTimeLowerPageState();
}

class _TestRestTimeLowerPageState extends State<TestRestTimeLowerPage> {
  ...
  void _goToExercisePage() {
    ...
    if(widget.currentSet-1!=0){
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => TestRealExerciseLowerPage(sets: widget.currentSet-1, exercises: widget.exercises, currentIndex:widget.currentIndex),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => LowerTotalDemonstrateExercisePage(
